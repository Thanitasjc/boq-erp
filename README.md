...
| Backend API (Render) | https://boq-erp-api.onrender.com |
...
| Variable | Value |
|----------|-------|
| `NEXT_PUBLIC_API_URL` | `https://boq-erp-api.onrender.com/api` |
...
| API | `http://localhost:8000/api` | `https://boq-erp-api.onrender.com/api` |
